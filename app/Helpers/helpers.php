...
class SiteHelpers
{
    ...
    public static function ayar($str)
    {
    ...
    public static function ImageDelete($value)
    {

        $image = public_path($value->image);
        if (file_exists($image)) {
            File::delete($image);
        }
        return true;
    }
    public static function CatBgDelete($value)
    {

        $image = public_path($value->cat_bg);
        if (file_exists($image)) {
            File::delete($image);
        }
        return true;
