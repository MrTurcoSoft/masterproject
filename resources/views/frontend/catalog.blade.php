        ...
        <div class="container pos-vertical-center">
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 text-center">
                    <h2>{{\Stichoza\GoogleTranslate\GoogleTranslate::trans('CATALOGUE’S',app()->getLocale())}}</h2>
                </div>
            </div>
            <!--end row-->
        </div>
                            ...
                            <a href="{{$value->file}}" target="_blank" download="{{\Stichoza\GoogleTranslate\GoogleTranslate::trans($value->name,app()->getLocale())}}">
                                <div class="card card-7">
                                    <div class="card__image bg--white">
                                        <img src="{{asset($value->image)}}" width="33%" alt="{{$value->name}}">
                                    </div>
                                    <div class="card__body boxed bg--white text-center">
                                        <div class="card__title">
                                            <h5 class="text-uppercase">{{\Stichoza\GoogleTranslate\GoogleTranslate::trans($value->name,app()->getLocale())}} <br> </h5>
                        ...
                        @else
                            <div class="col-md-12 col-sm-6 masonry__item">
                                    ...
                                    <div class="card card-7">
                                        ...
                                        <div class="card__body boxed bg--white text-center">
                                            <div class="card__title">
                                                <h5 class="text-uppercase">{{\Stichoza\GoogleTranslate\GoogleTranslate::trans('No catalog found!',app()->getLocale())}} <br> </h5>
