...
@section('title',env('APP_NAME').' | Sertifikalar ve Belgelerimiz')
@section('page-css')
...
@section('content')
    ...
    <div class="content-wrapper container">
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Sertifikalar ve Belgelerimiz</h3>
                        <p class="text-subtitle text-muted">Sitedeki Sertifikaları ve Belgelerimizi buradan yönetebilirsiniz. </p>
                    </div>
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Sertifikalar ve Belgelerimiz</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="page-content">
            <section class="row">
                <div class="col-12">
                    <a onclick="ByTurcoSoftModal(this.href,'Yeni Sertifika/Belge Ekle');return false"
                            ...
                            <table id="myTable" class="table table-bordered table-striped table-hover">
                                ...
                                @foreach($certificate as $key=> $value)
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 10%">
                                                <a onclick="ByTurcoSoftModal(this.href,'Sertifika/Belge Düzenle');return false"
