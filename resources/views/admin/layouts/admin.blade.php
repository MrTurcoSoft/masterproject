            ...
            <div class="container">
                <div class="footer clearfix mb-0 text-muted">
                    <div class="float-start">
                        <p>{{date("Y")}} &copy; {{SiteHelpers::ayar("author")}}</p>
                    </div>
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart"></i></span> by <a
                                href="{{SiteHelpers::ayar("webmaster_url")}}">{{SiteHelpers::ayar("author")}}</a></p>
                    </div>
                </div>
            </div>
        </footer>
...
<!-- Modal Başlangıcı -->
<div class="modal fade" id="byturcosoft-modal" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="byturcosoft-modal-content">
...
<!-- Modal Bitişi -->
<script src="{{asset("admin/assets/compiled/js/jquery-3.7.1.min.js")}}"></script>
