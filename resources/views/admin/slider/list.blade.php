...
@section('title',env('APP_NAME').' | Slider Listesi ')
@section('page-css')
            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        ...
                        <p class="text-subtitle text-muted">Sitedeki Sliderları buradan yönetebilirsiniz. </p>
                    </div>
                            ...
                            <table id="myTable" class="table table-bordered table-striped">
                                ...
                                @foreach($slider as $key=> $value)
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 10%">
                                                <a onclick="ByTurcoSoftModal(this.href,'Slider Düzenle');return false"
                                                   href="{{route('slider-management.edit',$value->id)}}" title="Güncelle"
